...
var eSignpad = document.querySelectorAll('.e-signpad');

var _loop = function _loop(i) {
  signaturePad = new signature_pad__WEBPACK_IMPORTED_MODULE_0__["default"](eSignpad[i].querySelector("canvas"));
  submit = eSignpad[i].querySelector("button");
  clear = eSignpad[i].querySelector(".clear");
...
for (var i = 0; i < eSignpad.length; i++) {
  var signaturePad;
  var submit;
  var clear;
